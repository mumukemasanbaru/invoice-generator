	...
	<div class="container">
	 	...
	 	<div class="header-invoice">
			<div class="row">
	    		...
	    		<div class="col-md-6" style='float: left; width: 45%'>
	    			...
	    			<p> <?php echo $_POST['invoice-id']; ?> </p>
	    			<div class="label-invoice"> Tanggal </div>
	    			<p> <?php echo $_POST['invoice-datecreated']; ?> </p>
	    		</div>
	    	</div>
		</div>
	    ...
	    <div class="Invoice-table">
	    	...
	    	<?php if(isset($_POST['table-item']) && is_array($_POST['table-item'])) : ?>
		    	...
		    	<tr>
		    		<td colspan="2"></td>
		    		<td colspan="2" class="pembatas" ></td>
		    	</tr>
		    	<tr>
		    		<td colspan="2"> </td>
		    		<td>Subtotal</td>
	    	...
	    	<div class="row">
		    	<div class="col-md-12">
		    		<div class="label-invoice"> Catatan </div>
		    		<p><?php echo $_POST['catatan']; ?></p>
		    	</div>
	    	</div>
	    </div>
